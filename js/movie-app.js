        ...
        fetch('https://quiet-purring-yellowhorn.glitch.me/movies')
            ...
            .then(movies => {
                ...
                for(let movie of movies){
                    htmlStr = `${htmlStr}<h1>${movie.title}</h1><p>by: ${movie.director}</p><p>Rating: ${movie.rating}</p>`
                }
...
getMovies()
    ...
    // }
    //
    // fetch("https://quiet-purring-yellowhorn.glitch.me/movies/10", deleteOptions).then(getMovies)
